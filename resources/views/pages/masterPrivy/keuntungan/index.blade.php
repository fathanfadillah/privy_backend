                            ...
                            <div class="form-row form-inline">
                                <div class="col-md-12">
                                    <div class="form-group m-0">
                                        <label for="title_keuntungan" class="col-form-label s-12 col-md-4">Title</label>
                                        <input type="text" name="title_keuntungan" id="title_keuntungan" placeholder="" class="form-control r-0 light s-12 col-md-8" autocomplete="off" required/>
                                    </div>
                                    <!-- <div class="form-group m-0">
                                    ...
                                    <div class="form-group m-0">
                                        <label for="deskripsi_keuntungan" class="col-form-label s-12 col-md-4">Deskripsi</label>
                                        <input type="text" name="deskripsi_keuntungan" id="deskripsi_keuntungan" placeholder="" class="form-control r-0 light s-12 col-md-8" autocomplete="off" required/>
                                    </div>
                                    <div class="form-group m-0">
...
<script type="text/javascript">
    var table = $('#dataTable').dataTable({
        ...
        columns: [
            ...
            {data: 'title_keuntungan', name: 'title_keuntungan'},
            // {data: 'no_telp', name: 'no_telp'},
            {data: 'deskripsi_keuntungan', name: 'deskripsi_keuntungan'},
            {data: 'icon', name: 'icon'},   
...
(function () {
    ...
    function edit(id) {
        ...
        $.get("{{ route($route.'edit', ':id') }}".replace(':id', id), function(data){
            ...
            $('#title_keuntungan').val(data.title_keuntungan);
            $('#deskripsi_keuntungan').val(data.deskripsi_keuntungan);
           }, "JSON").fail(function(){
            reload();
        });

...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::prefix('Master-Privy')->namespace('MasterPrivy')->name('master-privy.')->group(function () {
       ...
       Route::post('core/api', 'CoreController@api')->name('core.api');
        //dokumentasi
       ...
       Route::post('entrepreneur/api', 'EntrepreneurController@api')->name('entrepreneur.api');
       //Frequently Question
      ...
      //liveprivy
      Route::resource('liveprivy', 'LiveprivyController');
      Route::post('liveprivy/api', 'LiveprivyController@api')->name('liveprivy.api');
       // Penghargaan
